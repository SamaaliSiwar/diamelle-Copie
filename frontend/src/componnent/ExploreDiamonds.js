...
export default function ExploreDiamonds() {
  return (
    <div className="css-cd0a98">
      <ul>
        <li data-component-name="CardSliderCard" className="css-1xi4blx">
          <Link
            data-component-name="LinkBox"
            to="/seachdiamant/shape/Round"
            tabindex="0"
            className="css-3dvuxu"
          >
            <svg
        ...
        <li data-component-name="CardSliderCard" className="css-1xi4blx">
          <Link
            data-component-name="LinkBox"
            to="/seachdiamant/shape/Princess"
            className="css-3dvuxu"
            tabindex="0"
          >
            <svg
        ...
        <li data-component-name="CardSliderCard" className="css-1xi4blx">
          <Link
            data-component-name="LinkBox"
            to="/seachdiamant/shape/Marquise"
            className="css-3dvuxu"
            tabindex="0"
          >
            <svg
