        ...
        <div className="slider">
                <Slider />
                  ...
                  <div class="shell">
                    <div class="container">
                      <div className="css-zf4891">
                        <div class="css-11a7cfx">
                          <h2 data-component-name="Heading" class="css-ts8iv1">Solitaire</h2></div></div>
